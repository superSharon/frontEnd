	window.onload = function() {
				...
				var tabClick = control.querySelectorAll('.tabClick')[0];
				var tabLi = tabClick.getElementsByTagName('li');

				var tabBox = control.querySelectorAll('.tabBox')[0];
				var tabList = tabBox.querySelectorAll('.tabList');

				var lineBorder = control.querySelectorAll('.lineBorder')[0];
				...
				//滑动
				function chmove(ev) {
					var stars = control.querySelector('.active').start;
					ev.preventDefault;
					var touch = ev.touches[0];
